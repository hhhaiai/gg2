...
async def _fail_sync(token: str, mode_id: int, exc: BaseException | None = None) -> None:
    ...
    await _fail_sync_impl(token, mode_id, exc, label="console responses")
